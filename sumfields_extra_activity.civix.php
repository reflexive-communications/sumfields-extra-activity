...
spl_autoload_register('_sumfields_extra_activity_civix_class_loader', true, true);

function _sumfields_extra_activity_civix_class_loader($class)
{
    if ($class === 'CRM_SumfieldsExtraActivity_DAO_Base') {
        if (version_compare(CRM_Utils_System::version(), '5.74.beta', '>=')) {
            class_alias('CRM_Core_DAO_Base', 'CRM_SumfieldsExtraActivity_DAO_Base');
            // ^^ Materialize concrete names -- encourage IDE's to pick up on this association.
        } else {
            $realClass = 'CiviMix\\Schema\\SumfieldsExtraActivity\\DAO';
    ...
    if (strpos($class, 'CiviMix\\Schema\\SumfieldsExtraActivity\\') === 0) {
 ...
 */
function _sumfields_extra_activity_civix_civicrm_install()
{
    _sumfields_extra_activity_civix_civicrm_config();
    // Based on <compatibility>, this does not currently require mixin/polyfill.php.
}
 ...
 */
function _sumfields_extra_activity_civix_civicrm_enable(): void
{
    _sumfields_extra_activity_civix_civicrm_config();
    // Based on <compatibility>, this does not currently require mixin/polyfill.php.
}
